...
try:
    ...
    # Disable upstream tracing to avoid OpenAI API key lookups/requests
    set_tracing_disabled(True)
except Exception as e:
    raise ImportError(
        "Missing dependency 'openai-agents' that provides the 'agents' package. "
        "Install it with: pip install openai-agents"
    ) from e
try:
    from agents.extensions.handoff_prompt import RECOMMENDED_PROMPT_PREFIX  # type: ignore[import-not-found]
except Exception:
